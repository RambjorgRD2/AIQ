...
export const events: ForumEvent[] = [
  ...
  {
    lumaEventId: "evt-1tNVfQUsInwFzHF",
    title: "Sosial AI | Nybegynner",
    date: "2026-04-29",
    time: "10:00",
    timezone: "UTC",
    format: "Workshop",
    location: "PEAK Sunnfjord, Hafstadvegen 23, Hafstadvegen 25, 6800 Førde, Norway",
    description: "PEAK Sunnfjord Førde, Vestland Norway Er du heilt ny innanfor AI, men ynskjer å lære korleis du kan begynne å bruke AI ~ då er dette kurset for deg 😉",
    tierRecommended: "Beginner",
    host: 'Sosial AI Forum',
    capacity: null,
    status: "upcoming",
  },
  {
    lumaEventId: "evt-rJyZTxQqHLAVYEX",
    title: "AI Summit Norway",
    date: "2026-08-29",
    time: "13:00",
    timezone: "UTC",
    format: "Meetup",
    location: "Scandic Sunnfjord, Storehagen 2, 6800 Førde, Norway",
    description: "Scandic Sunnfjord Førde, Vestland Norway",
    tierRecommended: "All tiers",
    host: 'Sosial AI Forum',
    capacity: null,
    status: "upcoming",
